...
set targetDirectory=%CD%/../Client/模版_单独输出-Sheet7-选定范围题型.json
ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json sheetName Sheet7 jsonType JArray startCell A13 autoExit 1

set sourceDirectory=%CD%/数据配表/模版.xlsx
set targetDirectory=%CD%/../Client/模版_单独输出-Sheet7-选定范围.json
ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json sheetName Sheet7 jsonType JObject endCell F6
