...
set sourceDirectory=%CD%/数据配表/item.xlsx
set targetDirectory=%CD%/../Client/item_输出JsonObject.json

ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json jsonType JObject mainkey ID
