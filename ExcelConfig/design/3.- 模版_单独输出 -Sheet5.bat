...
set targetDirectory=%CD%/../Client/模版_单独输出-Sheet5.json

ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json sheetName Sheet5
