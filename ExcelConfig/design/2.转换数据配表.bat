...
set sourceDirectory=%CD%/数据配表
set targetDirectory=%CD%/../Server

ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json jsonGroup server autoExit 1

set sourceDirectory=%CD%/数据配表
set targetDirectory=%CD%/../Client
set unGroupDirectory=%CD%/../Client

ExcelToConfigGame sourceDirectory %sourceDirectory% targetDirectory %targetDirectory% searchOption 1 jsonformat 1 program Json jsonGroup client unGroupDirectory %unGroupDirectory%
